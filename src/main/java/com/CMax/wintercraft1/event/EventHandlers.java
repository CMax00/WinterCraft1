...
public class EventHandlers {
    ...
    private static void registerBlockBreak() {
        PlayerBlockBreakEvents.BEFORE.register((world, player, pos, state, blockEntity) -> {
            ...
            if (block == Blocks.ANCIENT_DEBRIS && JobManager.getJob(sp) != Job.MINER) {
